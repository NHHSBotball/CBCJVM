...
public class Simulator {
	...
	public Simulator(Sound sound, Sensor sensor, cbc.low.Device device,
	...
	protected void init(Sound sound, Sensor sensor, cbc.low.Device device,
	                    Display display, Input input, Servo servo, Motor motor,
	                    Camera camera, Create create) {
		setSound(sound);
		setSensor(sensor);
	...
	protected void setDevice(cbc.low.Device device) {
		this.device = device;
	}
	
	public cbc.low.Device getDevice() {
		return device;
	}
