...
package cbc.movement;

import cbc.easing.EasingEquation;
 ...
 * @author Grady Bryson
 * @see	cbc.movement.plugins
 * @see	cbc.movement.plugins.MovementPlugin
 */
...
public class DriveTrain {
	 ...
	 * @see       #freeze
	 * @see       #kill
	 * @see       cbc.movement.plugins.MovementPlugin#stop
	 */
	public void stop() {
		plugin.stop();
		updateOldPos();
	 ...
	 * @see       #stop
	 * @see       #kill
	 * @see       cbc.movement.plugins.MovementPlugin#freeze
	 */
	public void freeze() {
		plugin.freeze();
		updateOldPos();
	 ...
	 * @see       #stop
	 * @see       #freeze
	 * @see       cbc.movement.plugins.MovementPlugin#kill
	 */
	public void kill() {
		plugin.kill();
		updateOldPos();
	 ...
	 * @see       cbc.movement.plugins.MovementPlugin#getLeftMaxCmps
	 * @see       cbc.movement.plugins.MovementPlugin#getRightMaxCmps
	 */
